/* ===== Data unit NuMotorindo (demo) ===== */
const WA_NUMBER = '6281234567890';
const COND_LABELS = { 'like-new': 'Like New', 'bagus': 'Bagus', 'muluz': 'Mulus' };
...
const BIKES = [
  ...
  { id:'r15', name:'Yamaha R15 Connected', brand:'Yamaha', type:'sport', typeName:'Sport',
    ...
    desc:'R15 Connected 2023 full ori belum disentuh, servis rutin Yamaha. Like new abis. Bonus cover body & sarung jokor.' },
...
/* ===== Koneksi ke backend ===== */
/* Jalankan backend:  cd ../backend  lalu  node server.js   */
const NUMO_API_BASE = 'http://localhost:3000';